    ...
    def run_algorithm(self):
        ...
        for crossover_operator in crossover_operator_validation:
            ...
            with open(os.path.join(path, "algorithm_log.txt"), "a") as f:
                ...
                f.write(f"Population size: {self.POPULATION}\n")
                f.write(f"Number of generations: {self.GENERATIONS}\n")
                f.write(f"Mutation probability: {self.MUTATION_PROBABILITY}\n")
                f.write(f"Number of elites in each generation: {self.ELITE_CARRY_OVER}\n")
